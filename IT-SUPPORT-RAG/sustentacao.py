...
class ChromaDBManager:
    def __init__(self, persist_directory: str, client_name: str = None):
    ...
    def create_or_load_db(
        ...
        # client_name: str = client_name  ## make sure the collection name is the same!
    ) -> Chroma:
...
# startChromaDB = ChromaDBManager(persist_directory, "claro")
# print(startChromaDB)
...
def main():
    ...
    st.set_page_config(page_title="Sustenção RAG ", layout="wide")
    st.title("RAG System for sustentação")

    # Initialize paths
    current_dir = os.path.dirname(os.path.abspath(__file__))
    data_directory = os.path.join(current_dir, "data")
    persist_directory = os.path.join(current_dir, "chroma_clients")
